...
// projects/c3-components-docs/src/app/pages/docs/pages/tabs/pages/api/api.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApiComponent, { className: "ApiComponent", filePath: "projects/c3-components-docs/src/app/pages/docs/pages/tabs/pages/api/api.component.ts", lineNumber: 9 });
})();

// projects/c3-components-docs/src/app/pages/docs/pages/tabs/pages/examples/examples.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExamplesComponent, { className: "ExamplesComponent", filePath: "projects/c3-components-docs/src/app/pages/docs/pages/tabs/pages/examples/examples.component.ts", lineNumber: 9 });
})();

// projects/c3-components-docs/src/app/pages/docs/pages/tabs/tabs-routing.module.ts
var routes = [
  {
    path: "",
...
var _TabsRoutingModule = class _TabsRoutingModule {
};
...
var TabsRoutingModule = _TabsRoutingModule;
(() => {
...
// projects/c3-components-docs/src/app/pages/docs/pages/tabs/tabs.module.ts
...
_TabsModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _TabsModule });
_TabsModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [
  CommonModule,
  TabsRoutingModule
] });
...
//# sourceMappingURL=chunk-IFDJFD5S.js.map
