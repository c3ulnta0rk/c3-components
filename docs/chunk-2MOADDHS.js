import{a as Z,d as $,e as ee}from"./chunk-XNI3SQ5Z.js";import{b as ie,c as te}from"./chunk-HXFBUFMM.js";import{g as K,p as ae}from"./chunk-G2CQHUS4.js";import{c as W,n as z}from"./chunk-2LKJFBNO.js";import"./chunk-WXI33M2S.js";import{a as G,d as J}from"./chunk-A5ZCAORE.js";import{k as X}from"./chunk-TYWX7RIN.js";import{m as N}from"./chunk-ZKGLAAME.js";import{$ as E,$b as R,Bb as Q,Db as r,Ec as H,G as A,Ka as y,Nb as s,Ob as u,Qb as P,Rb as x,Vb as U,Wb as T,Xb as _,Yb as k,Yc as Y,ac as L,bc as O,da as I,dd as m,fa as d,fc as C,gb as o,gc as n,hb as g,j as S,jb as j,jc as B,kc as D,lc as c,o as w,oa as p,pa as v,pb as V,qa as F,xa as h}from"./chunk-VGXVW5OM.js";var ue=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275cmp=p({type:e,selectors:[["c3-api"]],standalone:!0,features:[D],decls:3,vars:0,template:function(i,l){i&1&&(s(0,"p"),n(1,"api works!"),u(),n(2,`,
`))},dependencies:[m],styles:["[_nghost-%COMP%]{display:block}"]});let t=e;return t})();var de=["*"];function pe(t,e){if(t&1&&(s(0,"div",0),k(1),u()),t&2){let oe=T();r("ngClass",oe.dropdownClass)}}var se=(()=>{let e=class e{constructor(a){this._changeDetectorRef=a,this.dropdownClass=""}ngOnChanges(a){a.dropdownClass&&this._markForCheck()}_markForCheck(){this._changeDetectorRef.markForCheck()}};e.\u0275fac=function(i){return new(i||e)(g(H))},e.\u0275cmp=p({type:e,selectors:[["c3-dropdown"]],viewQuery:function(i,l){if(i&1&&R(j,5),i&2){let f;L(f=O())&&(l.template=f.first)}},inputs:{dropdownClass:"dropdownClass"},features:[h],ngContentSelectors:de,decls:1,vars:0,consts:[[1,"c3-dropdown-panel",3,"ngClass"]],template:function(i,l){i&1&&(_(),Q(0,pe,2,1,"ng-template"))},dependencies:[Y],encapsulation:2});let t=e;return t})();var ge={provide:W,useExisting:I(()=>M),multi:!0},M=(()=>{let e=class e{get dropdownDisabled(){return this._dropdownDisabled}set dropdownDisabled(a){this._dropdownDisabled=X(a)}constructor(a,i,l){this._element=a,this._overlay=i,this._viewContainerRef=l,this._closingActionsSubscription=S.EMPTY,this._destroyed=new w,this._dropdownClass="",this._dropdownDisabled=!1,this.dropdownClass=""}onClick(){this.show()}ngOnChanges(a){a.dropdownClass&&this.dropdown&&(this.dropdown.dropdownClass=this._dropdownClass,this.dropdown._markForCheck())}ngOnDestroy(){this._destroyed.next(),this._destroyed.complete(),this._closingActionsSubscription.unsubscribe(),this.close()}show(){if(!this.dropdown)return;let a=this._overlay.create(this._getOverlayConfig()),i=new K(this.dropdown.template,this._viewContainerRef);a.attach(i),this.overlayRef=a,this._closingActionsSubscription=this._menuClosingActions().subscribe(()=>this.close())}close(){this.overlayRef&&this.overlayRef.hasAttached()&&this.overlayRef.detach()}_getOverlayConfig(){let a={originX:"start",originY:"bottom",overlayX:"start",overlayY:"top"},i={originX:"start",originY:"top",overlayX:"start",overlayY:"bottom",panelClass:"mat-autocomplete-panel-above"},l=this._overlay.position().flexibleConnectedTo(this._element).withLockedPosition().withPositions([a,i]);return new Z({positionStrategy:l,backdropClass:"cdk-overlay-transparent-backdrop",hasBackdrop:!0})}_menuClosingActions(){let a=this.overlayRef.backdropClick(),i=this.overlayRef.detachments();return A(a,i).pipe(E(this._destroyed))}};e.\u0275fac=function(i){return new(i||e)(g(y),g($),g(V))},e.\u0275dir=F({type:e,selectors:[["","c3Dropdown",""]],hostBindings:function(i,l){i&1&&U("click",function(){return l.onClick()})},inputs:{dropdown:[0,"c3Dropdown","dropdown"],dropdownDisabled:[0,"c3DropdownDisabled","dropdownDisabled"],dropdownClass:[0,"c3DropdownClass","dropdownClass"]},exportAs:["c3DropdownTrigger"],features:[B([ge]),h]});let t=e;return t})();var ne=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275mod=v({type:e}),e.\u0275inj=d({imports:[m,ee]});let t=e;return t})();var b=()=>({}),re=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275cmp=p({type:e,selectors:[["c3-examples"]],standalone:!0,features:[D],decls:61,vars:15,consts:[["dropdown",""],["dropdownTemplate",""],["dropdownVeryLongTemplate",""],[1,"my-4"],[1,"mb-2","px-4","pb-2"],["title",""],["label","TypeScript"],["highlight-js","","lang","typescript",3,"options"],["label","HTML"],["highlight-js","","lang","html",3,"options"],["example",""],["mat-raised-button","",3,"c3Dropdown"],[1,"pa-1"]],template:function(i,l){if(i&1&&(s(0,"p",3),n(1,"This is just a simple dropdown component with a template"),u(),s(2,"example-viewer",4)(3,"h4",5),n(4,"Basic dropdown"),u(),s(5,"c3-example-viewer-tab",6)(6,"div")(7,"textarea",7),n(8,`import { Component } from '@angular/core';
...
export class DropdownExampleComponent {}
      `),u()()(),s(9,"c3-example-viewer-tab",8)(10,"div")(11,"textarea",9),n(12,`<button mat-raised-button [c3Dropdown]="dropdown">Dropdown trigger</button>

<c3-dropdown #dropdown>
  Dropdown content
</c3-dropdown>
      `),u()()(),P(13,10),s(14,"button",11),n(15,"Dropdown trigger"),u(),s(16,"c3-dropdown",null,0),n(18," Dropdown content "),u(),x(),u(),s(19,"example-viewer",4)(20,"h4",5),n(21,"Dropdown with template"),u(),s(22,"c3-example-viewer-tab",6)(23,"div")(24,"textarea",7),n(25,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
`),u()()(),s(26,"c3-example-viewer-tab",8)(27,"div")(28,"textarea",9),n(29,`<button mat-raised-button [c3Dropdown]="dropdownTemplate">Dropdown trigger</button>
...
<c3-dropdown #dropdownTemplate>
  <div class="pa-1">
    ...
    <p>
      ...
      `),u()()(),P(30,10),s(31,"button",11),n(32," Dropdown trigger "),u(),s(33,"c3-dropdown",null,1)(35,"div",12)(36,"h4"),n(37,"Dropdown template"),u(),s(38,"p"),n(39,"This is a dropdown template"),u()()(),x(),u(),s(40,"example-viewer",4)(41,"h4",5),n(42,"Dropdown with dropdownVeryLongTemplate"),u(),s(43,"c3-example-viewer-tab",6)(44,"div")(45,"textarea",7),n(46,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
      `),u()()(),s(47,"c3-example-viewer-tab",8)(48,"div")(49,"textarea",9),n(50,`<button mat-raised-button [c3Dropdown]="dropdownVeryLongTemplate">Dropdown trigger</button>
