import{c as te,i as ae,j as ue}from"./chunk-3EUK4EJI.js";import{b as se,c as ne}from"./chunk-IGHIKPM7.js";import{g as ie,p as re}from"./chunk-IQEWDOWY.js";import"./chunk-O2VT6O52.js";import{c as K,d as Z}from"./chunk-GE74CIZ5.js";import"./chunk-AWLEKEVE.js";import{n as N}from"./chunk-XO7UL54F.js";import{a as $,l as ee}from"./chunk-C6OSHIVD.js";import{$ as I,Ba as j,C as A,Fc as X,Ic as q,Jc as G,Mc as J,Nc as W,Ob as r,Pb as s,Qb as a,Sb as U,Tb as _,Vb as f,W as E,Wb as h,_a as o,_b as k,ac as R,ba as c,bc as L,bd as z,cc as O,fa as F,gb as D,gd as x,h as S,ic as B,jb as b,jc as H,kc as P,lb as V,m as w,pb as d,pc as u,qb as p,rb as Q,tc as Y,uc as m,va as y,vb as T}from"./chunk-RPEIJ3SN.js";var le=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275cmp=d({type:e,selectors:[["c3-api"]],decls:3,vars:0,template:function(i,l){i&1&&(U(0,"p"),u(1,"api works!"),_(),u(2,`,
`))},styles:["[_nghost-%COMP%]{display:block}"]});let t=e;return t})();var qe=["*"];function be(t,e){if(t&1&&(s(0,"div",0),O(1),a()),t&2){let pe=R();r("ngClass",pe.panelClass())}}var oe=(()=>{let e=class e{constructor(){this.panelClass=q(),this.isOpen=y(!1),this.template=G.required(D),this._changeDetectorRef=F(W),X(()=>{this.panelClass()&&this._changeDetectorRef.markForCheck()})}};e.\u0275fac=function(i){return new(i||e)},e.\u0275cmp=d({type:e,selectors:[["c3-dropdown"]],viewQuery:function(i,l){i&1&&B(l.template,D,5),i&2&&H()},inputs:{panelClass:[1,"panelClass"]},standalone:!1,ngContentSelectors:qe,decls:1,vars:0,consts:[[1,"c3-dropdown-panel",3,"ngClass"]],template:function(i,l){i&1&&(L(),T(0,be,2,1,"ng-template"))},dependencies:[z],encapsulation:2});let t=e;return t})();var he={provide:$,useExisting:I(()=>M),multi:!0},M=(()=>{let e=class e{constructor(n,i,l){this._element=n,this._overlay=i,this._viewContainerRef=l,this._closingActionsSubscription=S.EMPTY,this._destroyed=new w,this.dropdown=J.required({alias:"c3DropdownTrigger"}),this.dropdownDisabled=q(!1),this.dropdownClass=q("")}onClick(){this.show()}ngOnDestroy(){this._destroyed.next(),this._destroyed.complete(),this._closingActionsSubscription.unsubscribe(),this.close()}show(){if(!this.dropdown().template())return;this.dropdown().isOpen.set(!0);let n=this._overlay.create(this._getOverlayConfig()),i=new ie(this.dropdown().template(),this._viewContainerRef);n.attach(i),this.overlayRef=n,this._closingActionsSubscription=this._menuClosingActions().subscribe(()=>this.close())}close(){this.overlayRef&&this.overlayRef.hasAttached()&&this.overlayRef.detach(),this.dropdown().isOpen.set(!1)}_getOverlayConfig(){let n={originX:"start",originY:"bottom",overlayX:"start",overlayY:"top"},i={originX:"start",originY:"top",overlayX:"start",overlayY:"bottom",panelClass:"mat-autocomplete-panel-above"},l=this._overlay.position().flexibleConnectedTo(this._element).withLockedPosition().withPositions([n,i]);return new te({positionStrategy:l,backdropClass:"cdk-overlay-transparent-backdrop",hasBackdrop:!0})}_menuClosingActions(){let n=this.overlayRef.backdropClick(),i=this.overlayRef.detachments();return A(n,i).pipe(E(this._destroyed))}};e.\u0275fac=function(i){return new(i||e)(b(j),b(ae),b(V))},e.\u0275dir=Q({type:e,selectors:[["","c3DropdownTrigger",""]],hostBindings:function(i,l){i&1&&k("click",function(){return l.onClick()})},inputs:{dropdown:[1,"c3DropdownTrigger","dropdown"],dropdownDisabled:[1,"dropdownDisabled"],dropdownClass:[1,"dropdownClass"]},outputs:{dropdown:"c3DropdownTriggerChange"},standalone:!1,features:[Y([he])]});let t=e;return t})();var me=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275mod=p({type:e}),e.\u0275inj=c({imports:[x,ue]});let t=e;return t})();var g=()=>({}),ce=(()=>{let e=class e{};e.\u0275fac=function(i){return new(i||e)},e.\u0275cmp=d({type:e,selectors:[["c3-examples"]],decls:61,vars:15,consts:[["dropdown",""],["dropdownTemplate",""],["dropdownVeryLongTemplate",""],[1,"my-4"],[1,"mb-2","px-4","pb-2"],["title",""],["label","TypeScript"],["highlight-js","","lang","typescript",3,"options"],["label","HTML"],["highlight-js","","lang","html",3,"options"],["example",""],["mat-raised-button","",3,"c3DropdownTrigger"],[1,"pa-1"]],template:function(i,l){if(i&1&&(s(0,"p",3),u(1,"This is just a simple dropdown component with a template"),a(),s(2,"example-viewer",4)(3,"h4",5),u(4,"Basic dropdown"),a(),s(5,"c3-example-viewer-tab",6)(6,"div")(7,"textarea",7),u(8,`import { Component } from '@angular/core';
...
export class DropdownExampleComponent {}
      `),a()()(),s(9,"c3-example-viewer-tab",8)(10,"div")(11,"textarea",9),u(12,`<button mat-raised-button [c3DropdownTrigger]="dropdown">Dropdown trigger</button>

<c3-dropdown #dropdown>
  Dropdown content
</c3-dropdown>
      `),a()()(),f(13,10),s(14,"button",11),u(15,"Dropdown trigger"),a(),s(16,"c3-dropdown",null,0),u(18," Dropdown content "),a(),h(),a(),s(19,"example-viewer",4)(20,"h4",5),u(21,"Dropdown with template"),a(),s(22,"c3-example-viewer-tab",6)(23,"div")(24,"textarea",7),u(25,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
`),a()()(),s(26,"c3-example-viewer-tab",8)(27,"div")(28,"textarea",9),u(29,`<button mat-raised-button [c3DropdownTrigger]="dropdownTemplate">Dropdown trigger</button>
...
<c3-dropdown #dropdownTemplate>
  <div class="pa-1">
    ...
    <p>
      ...
      `),a()()(),f(30,10),s(31,"button",11),u(32," Dropdown trigger "),a(),s(33,"c3-dropdown",null,1)(35,"div",12)(36,"h4"),u(37,"Dropdown template"),a(),s(38,"p"),u(39,"This is a dropdown template"),a()()(),h(),a(),s(40,"example-viewer",4)(41,"h4",5),u(42,"Dropdown with dropdownVeryLongTemplate"),a(),s(43,"c3-example-viewer-tab",6)(44,"div")(45,"textarea",7),u(46,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
      `),a()()(),s(47,"c3-example-viewer-tab",8)(48,"div")(49,"textarea",9),u(50,`<button mat-raised-button [c3Dropdown]="dropdownVeryLongTemplate">Dropdown trigger</button>
