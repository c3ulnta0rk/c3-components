import{a as re}from"./chunk-6G7WH2DU.js";import{b as se,c as ne}from"./chunk-OU3IZBA3.js";import"./chunk-ROMPVTZG.js";import{c as ee,i as ie,j as te}from"./chunk-MBJBYIEM.js";import{g as $}from"./chunk-ENUS3AYZ.js";import{a as ue}from"./chunk-OEYL6T2Z.js";import{c as z,d as Z}from"./chunk-PEQUY4GQ.js";import"./chunk-OBP7XN6Z.js";import{a as ae}from"./chunk-2I6A6QTS.js";import{g as C}from"./chunk-AHIU6KM7.js";import"./chunk-D2JVOI32.js";import"./chunk-24HI4LVF.js";import"./chunk-QFITDM3P.js";import{i as K,n as D}from"./chunk-5WXWLFM7.js";import{$ as F,Ac as d,C as y,Da as T,Lc as X,Oc as f,Pc as W,Sb as o,Sc as G,Tb as r,Tc as J,Ub as n,W as I,Wb as i,Xb as t,Zb as E,_b as x,ab as c,ba as p,ec as O,fa as j,gc as R,h as M,hc as _,ib as P,ic as L,lb as h,m as A,nb as Q,oc as B,pc as H,qc as S,rb as v,sb as g,tb as U,vc as e,xa as V,xb as k,zc as Y}from"./chunk-RCGMRQ6T.js";var le=(()=>{let a=class a{};a.\u0275fac=function(u){return new(u||a)},a.\u0275cmp=v({type:a,selectors:[["c3-api"]],decls:230,vars:0,consts:[[1,"api-section"],[1,"api-table"],[1,"notes-list"]],template:function(u,m){u&1&&(i(0,"h1"),e(1,"Dropdown API"),t(),i(2,"section",0)(3,"h2"),e(4,"Import"),t(),i(5,"pre")(6,"code"),e(7,`import {
  C3DropdownModule,
  C3DropdownComponent,
  C3DropdownTrigger
...
</c3-dropdown>`),t()()(),i(202,"section",0)(203,"h2"),e(204,"Styling"),t(),i(205,"p"),e(206,"The dropdown panel has the class "),i(207,"code"),e(208,"c3-dropdown-panel"),t(),e(209," by default."),t(),i(210,"p"),e(211,"Import styles from:"),t(),i(212,"pre")(213,"code"),e(214,"@use 'c3-components/lib/c3-dropdown/styles/c3-dropdown';"),t()()(),i(215,"section",0)(216,"h2"),e(217,"Usage Notes"),t(),i(218,"ul",2)(219,"li"),e(220,"The dropdown automatically closes when clicking outside or on the backdrop."),t(),i(221,"li"),e(222,"Uses a transparent backdrop that captures clicks."),t(),i(223,"li"),e(224,"Implements "),i(225,"code"),e(226,"NG_VALUE_ACCESSOR"),t(),e(227," for form integration."),t(),i(228,"li"),e(229,"The trigger listens to click events by default."),t()()())},encapsulation:2});let s=a;return s})();var be=["*"];function qe(s,a){if(s&1&&(r(0,"div",0),L(1),n()),s&2){let pe=R();o("ngClass",pe.panelClass())}}var oe=(()=>{let a=class a{constructor(){this.panelClass=f(),this.isOpen=V(!1),this.template=W.required(P),this._changeDetectorRef=j(J),X(()=>{this.panelClass()&&this._changeDetectorRef.markForCheck()})}};a.\u0275fac=function(u){return new(u||a)},a.\u0275cmp=v({type:a,selectors:[["c3-dropdown"]],viewQuery:function(u,m){u&1&&B(m.template,P,5),u&2&&H()},inputs:{panelClass:[1,"panelClass"]},standalone:!1,ngContentSelectors:be,decls:1,vars:0,consts:[[1,"c3-dropdown-panel",3,"ngClass"]],template:function(u,m){u&1&&(_(),k(0,qe,2,1,"ng-template"))},dependencies:[K],encapsulation:2});let s=a;return s})();var he={provide:ae,useExisting:F(()=>N),multi:!0},N=(()=>{let a=class a{constructor(l,u,m){this._element=l,this._overlay=u,this._viewContainerRef=m,this._closingActionsSubscription=M.EMPTY,this._destroyed=new A,this.dropdown=G.required({alias:"c3DropdownTrigger"}),this.dropdownDisabled=f(!1),this.dropdownClass=f("")}onClick(){this.show()}ngOnDestroy(){this._destroyed.next(),this._destroyed.complete(),this._closingActionsSubscription.unsubscribe(),this.close()}show(){if(!this.dropdown().template())return;this.dropdown().isOpen.set(!0);let l=this._overlay.create(this._getOverlayConfig()),u=new $(this.dropdown().template(),this._viewContainerRef);l.attach(u),this.overlayRef=l,this._closingActionsSubscription=this._menuClosingActions().subscribe(()=>this.close())}close(){this.overlayRef&&this.overlayRef.hasAttached()&&this.overlayRef.detach(),this.dropdown().isOpen.set(!1)}_getOverlayConfig(){let l={originX:"start",originY:"bottom",overlayX:"start",overlayY:"top"},u={originX:"start",originY:"top",overlayX:"start",overlayY:"bottom",panelClass:"mat-autocomplete-panel-above"},m=this._overlay.position().flexibleConnectedTo(this._element).withLockedPosition().withPositions([l,u]);return new ee({positionStrategy:m,backdropClass:"cdk-overlay-transparent-backdrop",hasBackdrop:!0})}_menuClosingActions(){let l=this.overlayRef.backdropClick(),u=this.overlayRef.detachments();return y(l,u).pipe(I(this._destroyed))}};a.\u0275fac=function(u){return new(u||a)(h(T),h(ie),h(Q))},a.\u0275dir=U({type:a,selectors:[["","c3DropdownTrigger",""]],hostBindings:function(u,m){u&1&&O("click",function(){return m.onClick()})},inputs:{dropdown:[1,"c3DropdownTrigger","dropdown"],dropdownDisabled:[1,"dropdownDisabled"],dropdownClass:[1,"dropdownClass"]},outputs:{dropdown:"c3DropdownTriggerChange"},standalone:!1,features:[Y([he])]});let s=a;return s})();var me=(()=>{let a=class a{};a.\u0275fac=function(u){return new(u||a)},a.\u0275mod=g({type:a}),a.\u0275inj=p({imports:[D,te]});let s=a;return s})();var q=()=>({}),ce=(()=>{let a=class a{};a.\u0275fac=function(u){return new(u||a)},a.\u0275cmp=v({type:a,selectors:[["c3-examples"]],decls:61,vars:15,consts:[["dropdown",""],["dropdownTemplate",""],["dropdownVeryLongTemplate",""],[1,"my-4"],[1,"mb-2","px-4","pb-2"],["title",""],["label","TypeScript"],["highlight-js","","lang","typescript",3,"options"],["label","HTML"],["highlight-js","","lang","html",3,"options"],["example",""],["mat-raised-button","",3,"c3DropdownTrigger"],[1,"pa-1"]],template:function(u,m){if(u&1&&(r(0,"p",3),e(1,"This is just a simple dropdown component with a template"),n(),r(2,"example-viewer",4)(3,"h4",5),e(4,"Basic dropdown"),n(),r(5,"c3-example-viewer-tab",6)(6,"div")(7,"textarea",7),e(8,`import { Component } from '@angular/core';
...
export class DropdownExampleComponent {}
      `),n()()(),r(9,"c3-example-viewer-tab",8)(10,"div")(11,"textarea",9),e(12,`<button mat-raised-button [c3DropdownTrigger]="dropdown">Dropdown trigger</button>

<c3-dropdown #dropdown>
  Dropdown content
</c3-dropdown>
      `),n()()(),E(13,10),r(14,"button",11),e(15,"Dropdown trigger"),n(),r(16,"c3-dropdown",null,0),e(18," Dropdown content "),n(),x(),n(),r(19,"example-viewer",4)(20,"h4",5),e(21,"Dropdown with template"),n(),r(22,"c3-example-viewer-tab",6)(23,"div")(24,"textarea",7),e(25,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
`),n()()(),r(26,"c3-example-viewer-tab",8)(27,"div")(28,"textarea",9),e(29,`<button mat-raised-button [c3DropdownTrigger]="dropdownTemplate">Dropdown trigger</button>
...
<c3-dropdown #dropdownTemplate>
  <div class="pa-1">
    ...
    <p>
      ...
      `),n()()(),E(30,10),r(31,"button",11),e(32," Dropdown trigger "),n(),r(33,"c3-dropdown",null,1)(35,"div",12)(36,"h4"),e(37,"Dropdown template"),n(),r(38,"p"),e(39,"This is a dropdown template"),n()()(),x(),n(),r(40,"example-viewer",4)(41,"h4",5),e(42,"Dropdown with dropdownVeryLongTemplate"),n(),r(43,"c3-example-viewer-tab",6)(44,"div")(45,"textarea",7),e(46,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
      `),n()()(),r(47,"c3-example-viewer-tab",8)(48,"div")(49,"textarea",9),e(50,`<button mat-raised-button [c3Dropdown]="dropdownVeryLongTemplate">Dropdown trigger</button>
