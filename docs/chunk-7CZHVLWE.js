import{a as $,d as ee,e as ie}from"./chunk-FQ3QKPBQ.js";import{b as te,c as ue}from"./chunk-XSVI6WBR.js";import{g as Z,p as ae}from"./chunk-43MNO3RZ.js";import"./chunk-VMEAVLAH.js";import"./chunk-ZSSD5RUB.js";import{a as J,d as W}from"./chunk-B2K2JW2E.js";import"./chunk-DW6W5TPA.js";import{n as x}from"./chunk-UROJQV2A.js";import{a as z,l as K}from"./chunk-R4VREYKJ.js";import{$b as k,Ba as y,Gc as X,Hb as n,Rb as u,Sb as t,T as A,Tc as G,Ub as f,Vb as h,X as E,Z as c,Zb as U,_b as R,_c as o,ab as l,ac as L,ca as I,cb as D,e as N,fb as b,hb as j,hc as O,ib as V,ic as B,j as S,jc as P,kc as s,lb as Q,nc as H,oc as m,pb as d,qb as p,rb as T,wb as _,ya as q,z as w,za as F,zc as Y}from"./chunk-BJ7BWNUF.js";var se=(()=>{class e{static{this.\u0275fac=function(i){return new(i||e)}}static{this.\u0275cmp=d({type:e,selectors:[["c3-api"]],decls:3,vars:0,template:function(i,r){i&1&&(u(0,"p"),s(1,"api works!"),t(),s(2,`,
`))},dependencies:[o],styles:["[_nghost-%COMP%]{display:block}"]})}}return e})();var de=["*"];function pe(e,fe){if(e&1&&(u(0,"div",0),L(1),t()),e&2){let a=R();n("ngClass",a.panelClass())}}var ne=(()=>{class e{constructor(){this.panelClass=q(),this.isOpen=y(!1),this.template=V.required(D),this._changeDetectorRef=I(Y),X(()=>{this.panelClass()&&this._changeDetectorRef.markForCheck()})}static{this.\u0275fac=function(i){return new(i||e)}}static{this.\u0275cmp=d({type:e,selectors:[["c3-dropdown"]],viewQuery:function(i,r){i&1&&O(r.template,D,5),i&2&&B()},inputs:{panelClass:[1,"panelClass"]},standalone:!1,ngContentSelectors:de,decls:1,vars:0,consts:[[1,"c3-dropdown-panel",3,"ngClass"]],template:function(i,r){i&1&&(k(),_(0,pe,2,1,"ng-template"))},dependencies:[G],encapsulation:2})}}return e})();var ge={provide:z,useExisting:E(()=>C),multi:!0},C=(()=>{class e{constructor(a,i,r){this._element=a,this._overlay=i,this._viewContainerRef=r,this._closingActionsSubscription=N.EMPTY,this._destroyed=new S,this.dropdown=Q.required({alias:"c3DropdownTrigger"}),this.dropdownDisabled=q(!1),this.dropdownClass=q("")}onClick(){this.show()}ngOnDestroy(){this._destroyed.next(),this._destroyed.complete(),this._closingActionsSubscription.unsubscribe(),this.close()}show(){if(!this.dropdown().template())return;this.dropdown().isOpen.set(!0);let a=this._overlay.create(this._getOverlayConfig()),i=new Z(this.dropdown().template(),this._viewContainerRef);a.attach(i),this.overlayRef=a,this._closingActionsSubscription=this._menuClosingActions().subscribe(()=>this.close())}close(){this.overlayRef&&this.overlayRef.hasAttached()&&this.overlayRef.detach(),this.dropdown().isOpen.set(!1)}_getOverlayConfig(){let a={originX:"start",originY:"bottom",overlayX:"start",overlayY:"top"},i={originX:"start",originY:"top",overlayX:"start",overlayY:"bottom",panelClass:"mat-autocomplete-panel-above"},r=this._overlay.position().flexibleConnectedTo(this._element).withLockedPosition().withPositions([a,i]);return new $({positionStrategy:r,backdropClass:"cdk-overlay-transparent-backdrop",hasBackdrop:!0})}_menuClosingActions(){let a=this.overlayRef.backdropClick(),i=this.overlayRef.detachments();return w(a,i).pipe(A(this._destroyed))}static{this.\u0275fac=function(i){return new(i||e)(b(F),b(ee),b(j))}}static{this.\u0275dir=T({type:e,selectors:[["","c3DropdownTrigger",""]],hostBindings:function(i,r){i&1&&U("click",function(){return r.onClick()})},inputs:{dropdown:[1,"c3DropdownTrigger","dropdown"],dropdownDisabled:[1,"dropdownDisabled"],dropdownClass:[1,"dropdownClass"]},outputs:{dropdown:"c3DropdownTriggerChange"},standalone:!1,features:[H([ge])]})}}return e})();var re=(()=>{class e{static{this.\u0275fac=function(i){return new(i||e)}}static{this.\u0275mod=p({type:e})}static{this.\u0275inj=c({imports:[o,ie]})}}return e})();var g=()=>({}),le=(()=>{class e{static{this.\u0275fac=function(i){return new(i||e)}}static{this.\u0275cmp=d({type:e,selectors:[["c3-examples"]],decls:61,vars:15,consts:[["dropdown",""],["dropdownTemplate",""],["dropdownVeryLongTemplate",""],[1,"my-4"],[1,"mb-2","px-4","pb-2"],["title",""],["label","TypeScript"],["highlight-js","","lang","typescript",3,"options"],["label","HTML"],["highlight-js","","lang","html",3,"options"],["example",""],["mat-raised-button","",3,"c3DropdownTrigger"],[1,"pa-1"]],template:function(i,r){if(i&1&&(u(0,"p",3),s(1,"This is just a simple dropdown component with a template"),t(),u(2,"example-viewer",4)(3,"h4",5),s(4,"Basic dropdown"),t(),u(5,"c3-example-viewer-tab",6)(6,"div")(7,"textarea",7),s(8,`import { Component } from '@angular/core';
...
export class DropdownExampleComponent {}
      `),t()()(),u(9,"c3-example-viewer-tab",8)(10,"div")(11,"textarea",9),s(12,`<button mat-raised-button [c3DropdownTrigger]="dropdown">Dropdown trigger</button>

<c3-dropdown #dropdown>
  Dropdown content
</c3-dropdown>
      `),t()()(),f(13,10),u(14,"button",11),s(15,"Dropdown trigger"),t(),u(16,"c3-dropdown",null,0),s(18," Dropdown content "),t(),h(),t(),u(19,"example-viewer",4)(20,"h4",5),s(21,"Dropdown with template"),t(),u(22,"c3-example-viewer-tab",6)(23,"div")(24,"textarea",7),s(25,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
`),t()()(),u(26,"c3-example-viewer-tab",8)(27,"div")(28,"textarea",9),s(29,`<button mat-raised-button [c3DropdownTrigger]="dropdownTemplate">Dropdown trigger</button>
...
<c3-dropdown #dropdownTemplate>
  <div class="pa-1">
    ...
    <p>
      ...
      `),t()()(),f(30,10),u(31,"button",11),s(32," Dropdown trigger "),t(),u(33,"c3-dropdown",null,1)(35,"div",12)(36,"h4"),s(37,"Dropdown template"),t(),u(38,"p"),s(39,"This is a dropdown template"),t()()(),h(),t(),u(40,"example-viewer",4)(41,"h4",5),s(42,"Dropdown with dropdownVeryLongTemplate"),t(),u(43,"c3-example-viewer-tab",6)(44,"div")(45,"textarea",7),s(46,`import { Component } from '@angular/core';
import { C3DropdownModule } from 'c3-components';
import { MatButtonModule } from '@angular/material/button';
...
export class DropdownExampleComponent {}
      `),t()()(),u(47,"c3-example-viewer-tab",8)(48,"div")(49,"textarea",9),s(50,`<button mat-raised-button [c3Dropdown]="dropdownVeryLongTemplate">Dropdown trigger</button>
