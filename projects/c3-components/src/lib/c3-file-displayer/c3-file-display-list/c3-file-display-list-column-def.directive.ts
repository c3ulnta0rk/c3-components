...
export class C3FileDisplayListColumnDefDirective {
  ...
  public readonly headerCellDef = contentChild(C3FileDisplayListHeaderCellDefDirective, { descendants: true });
  public readonly cellDef = contentChild(C3FileDisplayListCellDefDirective, { descendants: true });
}
